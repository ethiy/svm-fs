...
\begin{document}
			...
			\begin{figure}[H]
				\ffigbox[\FBwidth]
				{
					\begin{subfloatrow}[2]
						\ffigbox[\FBwidth]
						{
							\includegraphics[width=.45\textwidth]{map_L_2_separation_1}
						}
						{
						...
						\ffigbox[\FBwidth]
						{
							\includegraphics[width=.45\textwidth]{map_L_2_separation}
						}
						{
			...
			\begin{figure}[H]
				\ffigbox[\FBwidth]
				{
					\begin{subfloatrow}[2]
						\ffigbox[\FBwidth]
						{
							\includegraphics[width=.45\textwidth]{separation_pol_2_1}
						}
						{
						...
						\ffigbox[\FBwidth]
						{
							\includegraphics[width=.45\textwidth]{separation_pol_2_2}
						}
						{
	...
	\begin{frame}{Changement d'espace}
		\begin{itemize}
			\item[--]<1-> Séparation linéaire dans le nouveau espace:
			\begin{figure}[H]
				\includegraphics[width=.7\textwidth]{separation_pol_2_3}
		...
		\begin{figure}[H]
			\ffigbox[\FBwidth]
			{
				\begin{subfloatrow}[2]
					\ffigbox[\FBwidth]
					{
						\includegraphics[width=.45\textwidth]{rbfs}
					}
					{
					...
					\ffigbox[\FBwidth]
					{
						\includegraphics[width=.45\textwidth]{polys}
					}
					{
			...
			\ffigbox[\FBwidth]
			{
				\includegraphics[width=.5\textwidth]{tanhs}
			}
			{
	...
	\begin{frame}[plain,c]
		...
		\begin{tikzpicture}
			\draw (0,0)node{};
			\draw (4.5,1) node[color =IGNGris, inner sep=0.5em, minimum size=0.5em, text centered,font=\LARGE] { Merci pour votre attention, };
			\draw (4.5,0) node[color =IGNGris, inner sep=0.5em, minimum size=0.5em, text centered,font=\LARGE] { Vous pouvez posez vos questions! };
