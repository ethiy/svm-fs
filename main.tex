		...
		\begin{figure}[H]
			\ffigbox[\FBwidth]
			{
				\begin{subfloatrow}[3]
					\ffigbox[\FBwidth]
					{
						\includegraphics[width=.3\textwidth]{rbfs}
					}
					{
					...
					\ffigbox[\FBwidth]
					{
						\includegraphics[width=.3\textwidth]{polys}
					}
					{
					...
					\ffigbox[\FBwidth]
					{
						\includegraphics[width=.3\textwidth]{tanhs}
					}
					{
			...
			{
				\caption{\label{fig::usual_kernels}  Kernel usuels.}
			}
		\end{figure}
	\end{frame}
